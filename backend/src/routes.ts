...
const models: TsoaRoute.Models = {
    ...
    "ItemCategory": {
        "dataType": "refEnum",
        "enums": ["adventuring-gear","ammunition","arcane-foci","armor","artisans-tool","druidic-foci","equipment-pack","gaming-set","heavy-armor","holy-symbol","kit","land-vehicle","light-armor","martial-melee-weapon","martial-ranged-weapon","martial-weapon","magic-item","medium-armor","melee-weapon","mount-or-other-animal","mount-or-vehicle","musical-instrument","other-tool","potion","powder","ranged-weapon","ring","necklace","rod","scroll","shield","simple-melee-weapon","simple-ranged-weapon","simple-weapon","staff","standard-gear","tack-harness-or-drawn-vehicle","tool","vehicle","wand","waterborne-vehicle","weapon","wondrous-item"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ItemRange": {
        "dataType": "refObject",
